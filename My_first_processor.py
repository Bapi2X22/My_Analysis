...
class My_first_processor(HggBaseProcessor):
    ...
    def process(self, events: awkward.Array) -> Dict[Any, Any]:
        ...
        leading_gen_photon_pt  = awkward.values_astype(self.choose_nth_object_variable(sorted_gen_photons.pt, 0, -999.0), "float32")
        subleading_gen_photon_pt = awkward.values_astype(self.choose_nth_object_variable(sorted_gen_photons.pt, 1, -999.0), "float32")
        leading_gen_photon_eta = awkward.values_astype(self.choose_nth_object_variable(sorted_gen_photons.eta, 0, -999.0), "float32")
        subleading_gen_photon_eta = awkward.values_astype(self.choose_nth_object_variable(sorted_gen_photons.eta, 1, -999.0), "float32")
        leading_gen_photon_phi = awkward.values_astype(self.choose_nth_object_variable(sorted_gen_photons.phi, 0, -999.0), "float32")
        subleading_gen_photon_phi = awkward.values_astype(self.choose_nth_object_variable(sorted_gen_photons.phi, 1, -999.0), "float32")
