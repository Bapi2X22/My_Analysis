...
out_dir = "/eos/user/b/bbapi/www/Systematics_study/Backgrounds/TTG1Jets/ext/HDNA_tightercut/"
os.makedirs(out_dir, exist_ok=True)

# ===============================
# Configuration
# ===============================
base_dir = "/eos/user/b/bbapi/My_Analysis/2024_efficiency_study/Backgrounds/"
...
for syst, pair in syst_pairs.items():
    ...
    # else:
        ...
        # Photon systematics
        # -------------------------------
    nom_dir  = f"{base_dir}/NTuples_BKG_2024_HDNA_{syst}/TTG1Jets_24SummerRun3/nominal/diphoton/*.parquet"
    up_dir   = f"{base_dir}/NTuples_BKG_2024_HDNA_{syst}/TTG1Jets_24SummerRun3/{pair['up']}/diphoton/*.parquet"
    down_dir = f"{base_dir}/NTuples_BKG_2024_HDNA_{syst}/TTG1Jets_24SummerRun3/{pair['down']}/diphoton/*.parquet"
