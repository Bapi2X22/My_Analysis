...
files = read_file_list("Signal_MC_WH_2024.txt")

output_dir = "skimmed_MC_2024_WH"
...
def process_file(file):
    ...
    try:
        ...
        return f"SUCCESS: {file} → {len(arrays_skim)} events"

    except Exception as e:
        return f"FAILED: {file} | Error: {str(e)}"

n_workers = 1   # adjust depending on CPU
