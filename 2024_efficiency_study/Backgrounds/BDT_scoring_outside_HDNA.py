...
INPUT_DIR = "/eos/user/b/bbapi/My_Analysis/2024_efficiency_study/Backgrounds/NTuples_BKG_2024_HDNA_presel_pBDT_score_pho15_copy"

OUTPUT_DIR = "/eos/user/b/bbapi/My_Analysis/2024_efficiency_study/Backgrounds/NTuples_BKG_2024_HDNA_presel_withAllBDTs"

MODEL_FILE = "/eos/user/b/bbapi/HiggsDNA_220526/HiggsDNA/higgs_dna/workflows/models/model_htoaaTo2b2g.pkl"

MASS_GRID = [12, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60]
...
for infile in files:
    ...
    if len(events) == 0:
        ...
        # Add empty BDT branches so schema matches non-empty files
        for m in MASS_GRID:
            events[f"bdt_{m}"] = ak.Array(
