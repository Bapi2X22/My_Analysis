...
base_dir = "/eos/user/b/bbapi/My_Analysis/2024_efficiency_study/NTuples_WH_2024_single_correction_check_HDNA_"
...
sample_path = "WH-2024M30/nominal/diphoton/*.parquet"

output_dir = "/eos/user/b/bbapi/www/Systematics_study/WH2024/weight_corrections/HDNA_tightercut/"
...
for corr in corrections:
    ...
    ROOT.gStyle.SetOptStat(111111)
    # Mass
    h_mass_corr = make_hist("h_mass_corr", ";m_{#gamma#gamma} [GeV];Events", 100, 20, 40)
    ROOT.gStyle.SetOptStat(111111)
    h_mass_nom  = make_hist("h_mass_nom",  ";m_{#gamma#gamma} [GeV];Events", 100, 20, 40)
    ROOT.gStyle.SetOptStat(111111)
